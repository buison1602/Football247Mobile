...
public class ArticleNewsAdapter extends RecyclerView.Adapter<ArticleNewsAdapter.ArticleViewHolder> {
    ...
    public ArticleNewsAdapter(List<Article> articleList, Context context) {
    ...
    public ArticleViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_article_news, parent, false);
        ...
        public ArticleViewHolder(@NonNull View itemView, final OnItemClickListener listener) {
            ...
            itemView.setOnClickListener(v -> {
                ...
                if (listener != null && position != RecyclerView.NO_POSITION) {
                    listener.onItemClick((Article) ((ArticleNewsAdapter) getBindingAdapter()).articleList.get(position));
                }
            });
        }
    }
